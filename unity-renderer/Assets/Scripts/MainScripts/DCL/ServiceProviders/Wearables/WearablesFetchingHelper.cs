...
namespace DCL.Helpers
{
    public static class WearablesFetchingHelper
    {
        ...
        // The https://nft-api.ftc.tc/v1/ endpoint doesn't fetch L1 wearables right now, if those need to be re-converted we should use that old endpoint again and change the WearablesAPIData structure again for that response.
        // public const string COLLECTIONS_FETCH_URL = "https://peer-lb.ftc.tc/lambdas/collections"; 
        public const string COLLECTIONS_FETCH_URL = "https://nft-api.ftc.tc/v1/collections?sortBy=newest&first=1000"; 
